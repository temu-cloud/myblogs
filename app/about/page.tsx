  ...
  <ContainerLayout>
    <div className='px-4 sm:px-12'>
      <div className='text-center mb-15'>
        <h1 className='text-3xl sm:text-4xl lg:text-5xl font-bold text-white'>About my blogs</h1>
      ...
      <div className='space-y-14'>
        <div className='grid grid-cols-1 md:grid-cols-2 gap-10 items-center'>
          <h2 className='text-2xl font-semibold text-gray-200 mb-4'>what we write about</h2>
      ...
      <p>whether you are just starting out or refining your skills myblog is designed to inspire better code for better thinking</p>
